"""Traveltime-petrophysical inversion example script.

This module runs a traveltime-petrophysical inversion on a
prepared synthetic crosshole mesh and data. It provides
``run_tt_petro_inversion`` and a ``__main__`` entrypoint for standalone
execution.
"""
...
def main():
    """Prepare data and run the default traveltime-petrophysical inversion.
    ...
    operators, and runs `run_tt_petro_inversion` with default parameters.
