"""Joint petrophysical inversion example script.

This module runs a joint petrophysical inversion on a prepared synthetic
crosshole mesh and data. It provides ``run_jpi_inversion`` and a
...
def main():
    """Prepare data and run the default joint petrophysical inversion.
    ...
    operators, and runs `run_jpi_inversion` with default parameters.
